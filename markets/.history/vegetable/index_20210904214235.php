    ...
    if (!isset($_SESSION['listVegeId'])) 
{
    ...
    foreach ($listVegetable as $item)//xuất thông tin tát cả sản phẩm ra màn hình
    {
    ...
    function findAmountById($id)//lấy số lượng sản phẩm theo id sản phẩm được thêm
    {
    ...
    $htmlCheckbox = '';
    foreach($listCategoryName as $item)//xuất các checkbox của danh mucj
    {
