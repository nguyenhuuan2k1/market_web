...
class Vegetable
{
    ...
    function getListByCateIDs($cateids)//lấy tất cả sản phẩm theo nhiều danh mục
    {
    ...
    function getByID($vegetableID)//lấy tất cả thông tin sản phẩm theo mã
    {
    ...
    function minusAmount($vegetableID, $amount)//cập nhật lại số lượng sản phẩm
    {
